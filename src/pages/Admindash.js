...
export default function Admindash() {
    ...
    const deleteHandler = (id) => {
        axios.delete(`https://loginbackend-vxo2.onrender.com/api/user/${id}`).then(res => window.location.reload(false));
    }
    useEffect(() => {
        axios.get('https://loginbackend-vxo2.onrender.com/api/user').then(res => setusers(res.data));
    }, [])
  return (
    <div>
        <h2>Users</h2>
